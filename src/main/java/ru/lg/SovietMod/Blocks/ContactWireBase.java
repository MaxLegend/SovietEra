...
public class ContactWireBase extends Block{
	...
	public ContactWireBase(String name, float hardness)
	{
		super(Material.IRON);
	...
	public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entityIn)
	{
		...
		public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
		{
			...
			if (state.getBlock() instanceof ContactWireBase )
			{
				if(!state.getBlock().isSideSolid(state, world, pos, facing)) {
					return connector instanceof ContactWireBase || connector == RegBlocks.contact_wire|| connector == RegBlocks.contact_wire_angle;
				}
			} 
			return false;
