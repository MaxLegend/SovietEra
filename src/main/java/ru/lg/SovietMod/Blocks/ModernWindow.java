...
public class ModernWindow extends BasicBlockSideWithCustomModel {
	...
	public ModernWindow(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
		super(materialIn, name, hardness, resistanse, soundtype);
		this.setDefaultState(this.blockState.getBaseState().withProperty(PANE_UP, Boolean.FALSE).withProperty(PANE_DOWN, Boolean.FALSE).withProperty(FACING, EnumFacing.NORTH).withProperty(BROKEN, false));
	}
	...
	private boolean attachesToBlock(IBlockState state, IBlockAccess world, BlockPos pos)
	{
		...
		return block instanceof ModernWindow || block instanceof ModernWindowLeaf ;
