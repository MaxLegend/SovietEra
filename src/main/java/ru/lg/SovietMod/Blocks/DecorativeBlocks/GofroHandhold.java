...
public class GofroHandhold extends BasicBlockSideWithCustomModel {
	...
	public GofroHandhold(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
