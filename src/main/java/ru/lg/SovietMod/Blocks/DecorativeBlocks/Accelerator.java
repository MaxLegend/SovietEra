...
public class Accelerator extends BasicBlockSideWithCustomModel {
	public static final PropertyBool ENABLE = PropertyBool.create("enable");
	public Accelerator(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
