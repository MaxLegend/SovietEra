...
public class BlockAnalogRedstone extends BasicBlock
{
    public BlockAnalogRedstone(Material materialIn, String name, float hardness, float resistanse,
			SoundType soundtype) {
		super(materialIn, name, hardness, resistanse, soundtype);
        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockAnalogRedstone.EnumAttachPosition.NONE).withProperty(EAST, BlockAnalogRedstone.EnumAttachPosition.NONE).withProperty(SOUTH, BlockAnalogRedstone.EnumAttachPosition.NONE).withProperty(WEST, BlockAnalogRedstone.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));

	}

	public static final PropertyEnum<BlockAnalogRedstone.EnumAttachPosition> NORTH = PropertyEnum.<BlockAnalogRedstone.EnumAttachPosition>create("north", BlockAnalogRedstone.EnumAttachPosition.class);
    public static final PropertyEnum<BlockAnalogRedstone.EnumAttachPosition> EAST = PropertyEnum.<BlockAnalogRedstone.EnumAttachPosition>create("east", BlockAnalogRedstone.EnumAttachPosition.class);
    public static final PropertyEnum<BlockAnalogRedstone.EnumAttachPosition> SOUTH = PropertyEnum.<BlockAnalogRedstone.EnumAttachPosition>create("south", BlockAnalogRedstone.EnumAttachPosition.class);
    public static final PropertyEnum<BlockAnalogRedstone.EnumAttachPosition> WEST = PropertyEnum.<BlockAnalogRedstone.EnumAttachPosition>create("west", BlockAnalogRedstone.EnumAttachPosition.class);
    ...
    {
        int i = 0;
        boolean flag = state.getValue(NORTH) != BlockAnalogRedstone.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != BlockAnalogRedstone.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != BlockAnalogRedstone.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != BlockAnalogRedstone.EnumAttachPosition.NONE;
...
//        state = state.withProperty(SOUTH, this.getAttachPosition(worldIn, pos, EnumFacing.SOUTH));
    ...
    private BlockAnalogRedstone.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
...
//                    {
//                        return BlockAnalogRedstone.EnumAttachPosition.UP;
//                    }
//
//                    return BlockAnalogRedstone.EnumAttachPosition.SIDE;
//                }
//            }
//
//            return BlockAnalogRedstone.EnumAttachPosition.NONE;
//        }
//        else
       {
            return BlockAnalogRedstone.EnumAttachPosition.SIDE;
