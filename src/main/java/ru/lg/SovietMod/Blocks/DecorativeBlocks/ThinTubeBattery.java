...
public class ThinTubeBattery extends BasicBlockSideWithCustomModel {
	...
	public ThinTubeBattery(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
