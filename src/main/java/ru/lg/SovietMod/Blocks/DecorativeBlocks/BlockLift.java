...
public class BlockLift extends BasicBlockSide
{
    public BlockLift(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype, boolean top) {
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        world.setBlockState(pos.up(), RegBlocks.lift_up.getDefaultState().withProperty(FACING, facing), 2);
    ...
    {
        world.destroyBlock(this == RegBlocks.lift_down ? pos.up() : pos.down(), false);
    }
    ...
    public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity)
    {
    	 if(entity instanceof EntityPlayer)
         {
             ...
             boolean top = this == RegBlocks.lift_up;
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        ...
        return state.getBlock() == RegBlocks.lift_up ? TOP_BOUNDING_BOX : BOTTOM_BOUNDING_BOX;
    }
    @Override
    ...
    {
        return new ItemStack(RegBlocks.lift_down).getItem();
    }

    @Override
    public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player)
    {
        return new ItemStack(RegBlocks.lift_down);
    }
    ...
    private List<AxisAlignedBB> getCollisionBoxList(IBlockState state, World world, BlockPos pos)
    {
        ...
        if(state.getBlock() == RegBlocks.lift_down)
        {
            list.add(BOTTOM);
        }
