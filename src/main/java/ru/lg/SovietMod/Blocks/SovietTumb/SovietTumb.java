...
public class SovietTumb extends BlockContainer {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		if (!(te instanceof TileEntityTumb)) {
			return false;
		} 
		player.openGui(SovietCore.INSTANCE, GuiHandler.GUI_TUMB, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
