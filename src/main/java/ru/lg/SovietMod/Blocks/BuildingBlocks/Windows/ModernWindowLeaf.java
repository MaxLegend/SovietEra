...
public class ModernWindowLeaf extends BasicBlockSideWithCustomModel {
	...
	public ModernWindowLeaf(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
