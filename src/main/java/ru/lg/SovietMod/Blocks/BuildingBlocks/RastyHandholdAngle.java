...
public class RastyHandholdAngle extends BasicBlockSideWithCustomModel {
	...
	public RastyHandholdAngle(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
