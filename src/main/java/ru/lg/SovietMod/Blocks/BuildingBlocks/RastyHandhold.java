...
public class RastyHandhold extends BasicBlockSideWithCustomModel {
	...
	public RastyHandhold(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
