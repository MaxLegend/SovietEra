...
public class WLabTable extends BlockContainer
{	
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);


	public WLabTable(String name)
	{
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		if (!(te instanceof TileEntityWLabTable)) {
			return false; 
		} 
		player.openGui(SovietCore.INSTANCE, GuiHandler.GUI_WLT, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	...
	{
		return new TileEntityWLabTable();
	}
@Override
