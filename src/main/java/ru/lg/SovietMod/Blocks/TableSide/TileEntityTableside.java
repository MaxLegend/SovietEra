...
public class TileEntityTableside extends TileEntity
{
   public InventoryBasic basic;

   public TileEntityTableside()
   {
       basic = new InventoryBasic("TablesideTile", false, 8);
   }
   ...
   {
       return new ContainerTableside(playerInventory, this);
   }
   @Override
