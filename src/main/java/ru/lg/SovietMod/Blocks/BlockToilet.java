...
public class BlockToilet extends BasicBlockSideWithCustomModel {
	...
	public BlockToilet(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
