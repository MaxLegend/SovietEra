...
import ru.lg.SovietMod.Blocks.SovietBed.EnumHalf;

public class BiolabTable extends BasicBlockSideWithCustomModel {
	private static AxisAlignedBB AABB = new AxisAlignedBB(0, 0, 0, 1, 0.9, 1);
	public static final PropertyEnum<EnumState> STATES = PropertyEnum.<EnumState>create("states", EnumState.class);
	public BiolabTable(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
	...
	private boolean attachesToBlock(IBlockState state, IBlockAccess world, BlockPos pos)
	{
		...
		return block instanceof BiolabTable;
