...
public class PanelBlockRotate extends BasicBlock {
	public static final PropertyDirection FACING = PropertyDirection.create("facing");
	public PanelBlockRotate(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
