...
public class EntityRedBanner extends EntityHanging implements IEntityAdditionalSpawnData {


	public EntityRedBanner(World world) {
		super(world);
	}

	public EntityRedBanner(World world, BlockPos pos, EnumFacing facing) {
		super(world, pos);
	...
	public void onBroken(@Nullable Entity brokenEntity) {
	    if (world.getGameRules().getBoolean("doEntityDrops")) {
	        ...
	        entityDropItem(new ItemStack(RegItems.item_red_banner), 0.0F);
	    }
	}
	@Override
