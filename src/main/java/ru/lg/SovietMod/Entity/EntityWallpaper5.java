...
public class EntityWallpaper5 extends EntityHanging implements IEntityAdditionalSpawnData {


	public EntityWallpaper5(World world) {
		super(world);
	}

	public EntityWallpaper5(World world, BlockPos pos, EnumFacing facing) {
		super(world, pos);
