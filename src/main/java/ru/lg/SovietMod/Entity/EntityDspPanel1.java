...
public class EntityDspPanel1 extends EntityHanging implements IEntityAdditionalSpawnData {


	public EntityDspPanel1(World world) {
		super(world);
	}

	public EntityDspPanel1(World world, BlockPos pos, EnumFacing facing) {
		super(world, pos);
	...
	public void onBroken(@Nullable Entity brokenEntity) {
	    if (world.getGameRules().getBoolean("doEntityDrops")) {
	        ...
	        entityDropItem(new ItemStack(RegItems.item_dsp_panel_1), 0.0F);
	    }
	}
