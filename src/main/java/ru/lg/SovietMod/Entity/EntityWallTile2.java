...
public class EntityWallTile2 extends EntityHanging implements IEntityAdditionalSpawnData {


	public EntityWallTile2(World world) {
		super(world);
	}

	public EntityWallTile2(World world, BlockPos pos, EnumFacing facing) {
		super(world, pos);
	...
	public void onBroken(@Nullable Entity brokenEntity) {
	    if (world.getGameRules().getBoolean("doEntityDrops")) {
	        ...
	        entityDropItem(new ItemStack(RegItems.item_walltile_2), 0.0F);
	    }
	}
	@Override
