...
public class RenderEntityWallpaper5 extends Render<EntityWallpaper5>
{
	
	private int list;
	public RenderEntityWallpaper5(RenderManager renderManagerIn)
	{
	...
	public void doRender(EntityWallpaper5 entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		...
		this.bindTexture(TextureLocation.WALLPAPER_5);
	...
	protected ResourceLocation getEntityTexture(EntityWallpaper5 entity)
	{
		return TextureLocation.WALLPAPER_5;
	}
	...
	public void renderDL(EntityWallpaper5 entity, int width, int height, int textureU, int textureV) {
		list = GL11.glGenLists(1);
		GL11.glNewList(list, GL11.GL_COMPILE);
	...
	private void renderPainting(EntityWallpaper5 painting, int width, int height, int textureU, int textureV)
	{
	...
	private void setLightmap(EntityWallpaper5 painting, float p_77008_2_, float p_77008_3_)
	{
