...
public class RenderEntityWallTile2 extends Render<EntityWallTile2>
{
	
	private int list;
	public RenderEntityWallTile2(RenderManager renderManagerIn)
	{
		super(renderManagerIn);
	}

	public void doRender(EntityWallTile2 entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	...
	protected ResourceLocation getEntityTexture(EntityWallTile2 entity)
	{
		return TextureLocation.WALL_TILE_2;
	}
	...
	public void renderDL(EntityWallTile2 entity, int width, int height, int textureU, int textureV) {
	...
	private void renderPainting(EntityWallTile2 painting, int width, int height, int textureU, int textureV)
	{
	...
	private void setLightmap(EntityWallTile2 painting, float p_77008_2_, float p_77008_3_)
	{
