...
public class RenderEntityWallpaper1 extends Render<EntityWallpaper>
{
	
	private int list;
	public RenderEntityWallpaper1(RenderManager renderManagerIn)
	{
	...
	public void doRender(EntityWallpaper entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		...
		this.bindTexture(TextureLocation.WALLPAPER_1);
	...
	{
		return TextureLocation.WALLPAPER_1;
	}
	...
	public void renderDL(EntityWallpaper entity, int width, int height, int textureU, int textureV) {
		list = GL11.glGenLists(1);
		GL11.glNewList(list, GL11.GL_COMPILE);
