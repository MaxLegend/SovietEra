...
public class RenderEntityWallpaper2 extends Render<EntityWallpaper2>
{


    public RenderEntityWallpaper2(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
    }

    public void doRender(EntityWallpaper2 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityWallpaper2 entity)
    {
        return TextureLocation.WALLPAPER_2;
    }
    ...
    private void renderPainting(EntityWallpaper2 painting, int width, int height, int textureU, int textureV)
    {
    ...
    private void setLightmap(EntityWallpaper2 painting, float p_77008_2_, float p_77008_3_)
    {
