...
public class RenderEntityWallCarpet extends Render<EntityWallCarpet>
{


    public RenderEntityWallCarpet(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
    }

    public void doRender(EntityWallCarpet entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        float f = 0.5F;
        GlStateManager.scale(0.25F, 0.166F, 0.125F);
    ...
    protected ResourceLocation getEntityTexture(EntityWallCarpet entity)
    {
        return TextureLocation.WALL_CARPET;
    }
    ...
    private void renderPainting(EntityWallCarpet painting, int width, int height, int textureU, int textureV)
    {
    ...
    private void setLightmap(EntityWallCarpet painting, float p_77008_2_, float p_77008_3_)
    {
