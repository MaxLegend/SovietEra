...
public class RenderEntityWallTile1 extends Render<EntityWallTile1>
{
	
	private int list;
	public RenderEntityWallTile1(RenderManager renderManagerIn)
	{
	...
	public void doRender(EntityWallTile1 entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		...
		this.bindTexture(TextureLocation.WALL_TILE_1);
	...
	protected ResourceLocation getEntityTexture(EntityWallTile1 entity)
	{
		return TextureLocation.WALL_TILE_1;
	...
	public void renderDL(EntityWallTile1 entity, int width, int height, int textureU, int textureV) {
	...
	private void renderPainting(EntityWallTile1 painting, int width, int height, int textureU, int textureV)
	{
	...
	private void setLightmap(EntityWallTile1 painting, float p_77008_2_, float p_77008_3_)
	{
