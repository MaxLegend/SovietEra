...
public class RenderEntityWallpaper3 extends Render<EntityWallpaper3>
{
  
    private int list;
    public RenderEntityWallpaper3(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
    }

    public void doRender(EntityWallpaper3 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.bindTexture(TextureLocation.WALLPAPER_3);
    ...
    protected ResourceLocation getEntityTexture(EntityWallpaper3 entity)
    {
        return TextureLocation.WALLPAPER_3;
    }
    ...
    private void renderPainting(EntityWallpaper3 painting, int width, int height, int textureU, int textureV)
    {
    ...
    private void setLightmap(EntityWallpaper3 painting, float p_77008_2_, float p_77008_3_)
    {
