...
public class RenderEntityWallpaper4 extends Render<EntityWallpaper4>
{
	
	private int list;
	public RenderEntityWallpaper4(RenderManager renderManagerIn)
	{
	...
	public void doRender(EntityWallpaper4 entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		...
		this.bindTexture(TextureLocation.WALLPAPER_4);
		...
		this.renderPainting(entity, 16, 16, 0, 0);
	...
	protected ResourceLocation getEntityTexture(EntityWallpaper4 entity)
	{
		return TextureLocation.WALLPAPER_4;
	}
	...
	public void renderDL(EntityWallpaper4 entity, int width, int height, int textureU, int textureV) {
		list = GL11.glGenLists(1);
		GL11.glNewList(list, GL11.GL_COMPILE);
		this.renderPainting(entity, width, height, textureU, textureV);
		GL11.glEndList();
		GL11.glCallList(list);
	}

	private void renderPainting(EntityWallpaper4 painting, int width, int height, int textureU, int textureV)
	{
	...
	private void setLightmap(EntityWallpaper4 painting, float p_77008_2_, float p_77008_3_)
	{
