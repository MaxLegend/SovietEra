...
public class RenderEntityRedBanner extends Render<EntityRedBanner>
{
  

    public RenderEntityRedBanner(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
    }

    public void doRender(EntityRedBanner entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityRedBanner entity)
    {
        return TextureLocation.RED_BANNER;
    }
    ...
    private void renderPainting(EntityRedBanner painting, int width, int height, int textureU, int textureV)
    {
    ...
    private void setLightmap(EntityRedBanner painting, float p_77008_2_, float p_77008_3_)
    {
