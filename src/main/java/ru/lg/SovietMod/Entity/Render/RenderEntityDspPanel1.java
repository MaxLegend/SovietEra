...
public class RenderEntityDspPanel1 extends Render<EntityDspPanel1>
{
	
	private int list;
	public RenderEntityDspPanel1(RenderManager renderManagerIn)
	{
	...
	public void doRender(EntityDspPanel1 entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		...
		this.bindTexture(TextureLocation.DSP_PANEL_1);
	...
	protected ResourceLocation getEntityTexture(EntityDspPanel1 entity)
	{
		return TextureLocation.DSP_PANEL_1;
	}
	...
	public void renderDL(EntityDspPanel1 entity, int width, int height, int textureU, int textureV) {
		list = GL11.glGenLists(1);
		GL11.glNewList(list, GL11.GL_COMPILE);
	...
	private void renderPainting(EntityDspPanel1 painting, int width, int height, int textureU, int textureV)
	{
	...
	private void setLightmap(EntityDspPanel1 painting, float p_77008_2_, float p_77008_3_)
	{
