...
public class EntityWallpaper4 extends EntityHanging implements IEntityAdditionalSpawnData {


	public EntityWallpaper4(World world) {
		super(world);
	}

	public EntityWallpaper4(World world, BlockPos pos, EnumFacing facing) {
		super(world, pos);
	...
	public void onBroken(@Nullable Entity brokenEntity) {
	    if (world.getGameRules().getBoolean("doEntityDrops")) {
	        ...
	        entityDropItem(new ItemStack(RegItems.item_wallpaper_4), 0.0F);
	    }
	}
