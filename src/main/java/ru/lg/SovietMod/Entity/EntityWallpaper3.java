...
public class EntityWallpaper3 extends EntityHanging implements IEntityAdditionalSpawnData {


	public EntityWallpaper3(World world) {
		super(world);
	}

	public EntityWallpaper3(World world, BlockPos pos, EnumFacing facing) {
		super(world, pos);
	...
	public void onBroken(@Nullable Entity brokenEntity) {
	    if (world.getGameRules().getBoolean("doEntityDrops")) {
	        ...
	        entityDropItem(new ItemStack(RegItems.item_wallpaper_3), 0.0F);
	    }
	}
