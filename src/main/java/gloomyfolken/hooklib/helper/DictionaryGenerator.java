...
public class DictionaryGenerator {
    ...
    public static void main(String[] args) throws Exception {
        List<String> lines = FileUtils.readLines(new File("C:/Users/Max/Desktop/Modding/SovietLab 1.12.2/libs/methods.csv"));
        lines.remove(0);
        ...
        DataOutputStream out = new DataOutputStream(new FileOutputStream("C:/Users/Max/Desktop/Modding/SovietLab 1.12.2/libs/methods.bin"));
